 ...
 * Description: Basic methods to run the Lobot Servo Controller(Ex: hiwonder, Lobot, 16ch, 32ch, etc) with the help of arduino. Read the attached servo 
   library <LobotServoController.cpp> and <LobotServoController.h> to understand the logic behind each function and method, to use it more flexibily in
   all your projects requiring complex tasks and logics.
**/

#include <LobotServoController.h> // Library

LobotServoController myse;  // No serial initialised, Default serial communication for arduino: 0RX, 0TX
