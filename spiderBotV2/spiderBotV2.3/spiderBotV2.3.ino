 ...
 * Updates: Added Coxa direction and Stride scale for the clockwise motor arrangement and 45 deg motor mouting(corner motor).
 *          Enhanced the tripodStep code.
 *
...
void btCallback(esp_spp_cb_event_t event, esp_spp_cb_param_t *param)
{
  if (event == ESP_SPP_SRV_OPEN_EVT)
  {
    ...
    SerialBT.println("SpiderBot V2.3 Ready!");
...
void handleCommand(char cmd)
{
  ...
  case '?':
    SerialBT.println("─── SpiderBot V2.3 ───");
...
void setup()
{
  ...
  Serial.println("SpiderBot V2.3 — Bluetooth started");
