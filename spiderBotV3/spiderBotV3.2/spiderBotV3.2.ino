 ...
 *
 * ── WHAT'S NEW IN V3.2 ───────────────────────────────────────
 *   - ArduinoOTA support for wireless code uploads! Uses a 5-sec
 *     timeout to preserve offline capability if WiFi is MIA.
 *   - Master ON/OFF state (R3) properly sleeps the robot.
 *   - D-pad fixes (held vs one-shot) to prevent infinite loops.
 *   - PS2 Polling rate-limited to 50ms to fix ghost inputs.
 *
 * ── BUTTON MAP ───────────────────────────────────────────────
